...
function install_packages_2 {
	sudo apt install raspinfo rpi.gpio-common raspi-gpio python-rpi.gpio python3-rpi.gpio i2c-tools spi-tools python3-picamera python-picamera u-boot-rpi rpiboot lm-sensors # rpi-specific
