...
find_type_f_iname long-tail.a.tar "*.abl" "*.abt" "*.acorn" "*.adf" "*.ael" "*.aff" "*.aifc" "*.aix" "*.aix5" "*.alc" "*.alias" "*.alien" "*.alphacxx6" "*.amiga" "*.amr" "*.ano" "*.ap" "*.api_description" "*.app" "*.asa" "*.asd" "*.ashx" "*.assuralastrun" "*.asv" "*.atari" "*.atf" "*.att" "*.aws"
find_type_f_iname long-tail.b.tar "*.b32" "*.bas" "*.bash_profile" "*.batch" "*.bc32" "*.belle" "*.beos" "*.bitfiles" "*.bkl" "*.bkmanifest" "*.bkpcc" "*.bl-ceem-075_0" "*.bl-ceem-075_1" "*.bl-ceem-075_2" "*.bl-ceem-075_3" "*.bl-ceem-075_4" "*.bl-ceem-075_5" "*.bl-ceem-075_6" "*.blg" "*.bof" "*.bor" "*.box" "*.boxl" "*.brk" "*.browser" "*.bsb" "*.bst" "*.bxml"
...
find_type_f_iname long-tail.d.tar "*.darwin" "*.dat%" "*.db-shm" "*.dbc" "*.dbk" "*.dds" "*.def" "*.defs" "*.den" "*.dep" "*.dependencies" "*.dev2" "*.df2" "*.dfa" "*.dff" "*.dft" "*.diag" "*.diagpkg" "*.dictionary" "*.diff" "*.dim" "*.din" "*.directory" "*.dirs" "*.diz" "*.dj2" "*.dlt" "*.dnv" "*.dot" "*.down" "*.dox" "*.dproj" "*.drk" "*.drl" "*.dru" "*.dsk" "*.dun" "*.dvc" "*.dwl"
...
find_type_f_iname long-tail.g.tar "*.g" "*.g2" "*.g4m" "*.g95" "*.gbm" "*.gdoc" "*.geom" "*.gitconfig" "*.gko" "*.gmmp" "*.gnome" "*.gnuplot_history" "*.gp" "*.gpg" "*.gplt" "*.gpt" "*.gsheet" "*.gslides" "*.gtkw" "*.guess" "*.gvp"
find_type_f_iname long-tail.h.tar "*.h1c" "*.h1k" "*.h1t" "*.h2m" "*.hdlsourcefiles" "*.hdr" "*.header" "*.hgignore" "*.hhp" "*.hi" "*.hif" "*.his" "*.hist" "*.history" "*.hit" "*.hp700" "*.hpgcc" "*.hpj" "*.hpreview" "*.hpu" "*.hpux" "*.hpuxacc" "*.hpuxia64acc" "*.hsprogs" "*.hst" "*.htaccess" "*.hwmdat" "*.hwmop" "*.hx1"
...
find_type_f_iname long-tail.l.tar "*.lai" "*.layer" "*.layerprf" "*.lci" "*.lck" "*.lcvdplfile" "*.ld07" "*.ldb" "*.ldf" "*.ldo" "*.ldp" "*.lds" "*.len" "*.ler" "*.library-ms" "*.libs" "*.lib~conc_intfc_lib" "*.lib~ft2u_lib" "*.lib~klm_scrod_tb" "*.lib~tdc_fifo_lib" "*.lib~tdc_lib" "*.lib~time_order_lib" "*.linux8664gcc" "*.linuxalphagcc" "*.linuxia64ecc" "*.linuxia64gcc" "*.linuxicc" "*.linuxkcc" "*.linuxx8664icc" "*.lk" "*.lnn" "*.lnp" "*.lnt" "*.lnx" "*.lnx8664" "*.loaded_0" "*.loaded_2" "*.loc" "*.loop" "*.lpc" "*.lpr" "*.lrs" "*.lso" "*.ltx"
find_type_f_iname long-tail.m.tar "*.m2b" "*.m3u" "*.ma" "*.macosx64" "*.macosxicc" "*.macosxxlc" "*.macro" "*.main" "*.man" "*.mappings" "*.marks" "*.master" "*.mcr" "*.md" "*.md1" "*.md5" "*.md5sum" "*.mem" "*.metadata" "*.metadata-v2" "*.mfd" "*.mgl" "*.mhs" "*.min" "*.minitel12-80" "*.mips" "*.mk" "*.mkr" "*.ml" "*.mllr" "*.mm" "*.mnl" "*.monalisa" "*.mos" "*.mplstyle" "*.mpp" "*.mrxvt" "*.mta"
...
find_type_f_iname long-tail.p.tar "*.pac" "*.panel" "*.pao" "*.pas" "*.patches" "*.pbxproj" "*.pch++" "*.pchmm" "*.pcm" "*.pd07" "*.pdr" "*.pdx" "*.pe" "*.pedsub_calcfd" "*.pedsub_hits" "*.pex2" "*.pf" "*.pfx" "*.pif" "*.pjh" "*.planner" "*.plc" "*.pll" "*.plo" "*.pls" "*.pol" "*.policy" "*.pop" "*.post" "*.pot" "*.ppc" "*.ppk" "*.ppr" "*.prefs" "*.prerm" "*.preun" "*.pri" "*.profile" "*.properties" "*.prx" "*.ps1" "*.psg" "*.ptf" "*.pts" "*.pub" "*.pulse-cookie" "*.pyf" "*.pyw"
...
find_type_f_iname long-tail.s.tar "*.s2p" "*.s4p" "*.sam" "*.save" "*.sb" "*.scat" "*.scc" "*.scf" "*.scheme" "*.scm" "*.sco" "*.scp" "*.scs" "*.scv" "*.sdbl" "*.sdbx" "*.sdc" "*.sdkproject" "*.search-ms" "*.searchconnector-ms" "*.sed" "*.sep" "*.service" "*.set" "*.settings" "*.setup_spartan3" "*.setup_spartan3e" "*.setup_virtex2" "*.setup_virtex2p" "*.sf2" "*.sggcc" "*.sgicc" "*.sgrd" "*.shl" "*.sid" "*.simnetlistrunfile" "*.sin" "*.size" "*.skin" "*.skp" "*.sm" "*.smhist" "*.snn" "*.so9" "*.sobecons" "*.solariscc5" "*.sp" "*.spi" "*.sr" "*.src" "*.srn" "*.ss5" "*.ss5v9" "*.st0" "*.state" "*.std" "*.stl" "*.stm" "*.storagerecordindex" "*.strm" "*.stuff" "*.stx" "*.sub" "*.subst" "*.sunos" "*.sunos5" "*.sunos5v9" "*.sva" "*.sve" "*.svi" "*.svn" "*.svn-work" "*.sw0" "*.swp" "*.symcmd" "*.symlog" "*.sysdef" "*.sysk" "*.syx"
find_type_f_iname long-tail.t.tar "*.tab" "*.tag" "*.targets" "*.tbc" "*.tbr" "*.tc3" "*.tcal" "*.tch" "*.tech" "*.terms" "*.testing_plots_forgaryanderic" "*.tf" "*.tfd" "*.tfi" "*.tfl" "*.tft" "*.thd" "*.theming" "*.thmx" "*.thumbnailer" "*.ti" "*.tii" "*.tim" "*.timing" "*.tis" "*.tlm" "*.tm" "*.tmml" "*.toc" "*.tool" "*.top" "*.tpr" "*.trace" "*.trans" "*.translations" "*.translators" "*.transr" "*.trm" "*.trn" "*.tsdb" "*.tsmeas" "*.tsp" "*.tsstr" "*.tvl" "*.tx12" "*.txf"
...
find_type_f_iname long-tail.x.tar "*.xa" "*.xaml" "*.xbap" "*.xcf" "*.xcn" "*.xdj" "*.xds" "*.xfigrc" "*.xil_info" "*.xinetd" "*.xld" "*.xlsm" "*.xlt" "*.xltx" "*.xmp" "*.xpr" "*.xps" "*.xrf" "*.xrm-ms_690f532f" "*.xsd" "*.xslt" "*.xterm-new" "*.xul" "*.xwbt" "*.xx" "*.xy"
find_type_f_iname long-tail.y.tar "*.yml"
find_type_f_iname long-tail.z.tar "*.zzz"

find_type_f_iname long-tail.10MB.tar "*.3" "*.6" "*.7" "*.acd" "*.acm" "*.adb" "*.adm" "*.adml" "*.admx" "*.adr" "*.ads" "*.afm" "*.ai" "*.ali" "*.amx" "*.ani" "*.aps" "*.art" "*.ax" "*.bat" "*.bcc" "*.bcm" "*.bkg" "*.bpl" "*.btr" "*.cbz" "*.cdf-ms" "*.cel" "*.cfg" "*.chq" "*.cls" "*.cmf" "*.cnv" "*.cpa" "*.crt" "*.csa" "*.d" "*.dat#" "*.dcm" "*.ddd" "*.dectest" "*.deu" "*.devhelp2" "*.dhp" "*.dmc" "*.dml" "*.dmo" "*.dms" "*.drv" "*.dtx" "*.dvg" "*.dvr-ms" "*.eco" "*.efi" "*.eml" "*.emn" "*.enu" "*.eps#" "*.exsd" "*.f" "*.fdf" "*.fits" "*.fmwr" "*.fon" "*.form" "*.g1" "*.g2l" "*.g3l" "*.g4" "*.g4l" "*.g5l" "*.g6l" "*.g7l" "*.gbc" "*.gbk" "*.gbp" "*.gbr" "*.gc2" "*.gc3" "*.gc4" "*.gc5" "*.gc6" "*.gc7" "*.gc8" "*.gc9" "*.gcc" "*.gd12" "*.gdo" "*.gdt" "*.gfl" "*.gid" "*.gir" "*.gise" "*.grc" "*.grd" "*.gtc" "*.gtk" "*.gtm" "*.gtp" "*.gwk" "*.hdx" "*.heic" "*.hkp" "*.hwdef" "*.hwh" "*.hxx" "*.hyp" "*.ico" "*.idb" "*.idf" "*.if2" "*.ifd" "*.il" "*.ime" "*.inc" "*.ind" "*.inx" "*.ipf" "*.itk" "*.jed" "*.jrs" "*.jsonlz4" "*.l" "*.lan" "*.less" "*.lex" "*.lf-r" "*.lgc" "*.lhp" "*.lis" "*.lng" "*.ltl" "*.lxa" "*.lyt" "*.m4" "*.mfl" "*.mine" "*.mjs" "*.mof" "*.msc" "*.msg" "*.msstyles" "*.mst" "*.mum" "*.nap" "*.ncb" "*.ndf" "*.nld" "*.nlp" "*.nlt" "*.ntf" "*.ocx_38c869db" "*.ods" "*.old" "*.pad" "*.pad_txt" "*.pages" "*.pd4" "*.pedsub_hitscfd" "*.pem" "*.pfa" "*.pfb" "*.pkginfo" "*.pl" "*.pm" "*.pptm" "*.prj" "*.psd" "*.pt07" "*.pyd" "*.r" "*.r53657" "*.r53921" "*.r54265" "*.ref" "*.regtrans-ms" "*.res" "*.resources" "*.rom" "*.rootmap" "*.rpo" "*.sav" "*.sbr" "*.sch_1" "*.schdot" "*.sdf" "*.sdo" "*.shx" "*.sql" "*.srp" "*.sty" "*.sym" "*.tax2017" "*.tcc" "*.texi" "*.tfm" "*.tlb" "*.tpl" "*.tui" "*.ui" "*.upd" "*.usb0" "*.vc" "*.vch" "*.vdf" "*.vf" "*.vh" "*.vm6" "*.vp" "*.wat" "*.wcfg" "*.whl" "*.wma" "*.wmf" "*.wsp" "*.wxform" "*.xco" "*.xda" "*.xpd" "*.xpi" "*.xpm" "*.xraw" "*.xrm-ms" "*.xsl" "*.xtd" "*.xwv" "*.zap"

find_type_f_iname long-tail.100MB.tar "*.0" "*.1" "*.2" "*.4" "*.5" "*.am" "*.asc" "*.axy" "*.bfd" "*.bre" "*.cam" "*.cat" "*.chm" "*.cio" "*.cpl" "*.css" "*.cxt" "*.db-wal" "*.dcs" "*.dic" "*.did" "*.dlm" "*.dly" "*.dmp" "*.dra" "*.drklog" "*.dsn" "*.dsp" "*.easm" "*.el" "*.elc" "*.enc" "*.epsi" "*.etl" "*.fst" "*.gd10" "*.gd11" "*.gd2" "*.gd3" "*.gd4" "*.gd5" "*.gd6" "*.gd7" "*.gd8" "*.gd9" "*.gpd" "*.h1s" "*.hbk" "*.hepevt" "*.hh" "*.hlp" "*.hlt" "*.ibs" "*.icc" "*.icm" "*.idx" "*.igs" "*.ilk" "*.imd" "*.in" "*.inf" "*.info" "*.ini" "*.isu" "*.js" "*.jsa" "*.ldz" "*.llb" "*.lrc" "*.lzp" "*.manifest" "*.max" "*.mcm" "*.mdb" "*.mnf" "*.mo" "*.msk" "*.nls" "*.ntp" "*.ocx" "*.odg" "*.ou" "*.pak" "*.part" "*.pb" "*.pdb" "*.peddiff" "*.pho" "*.pkg" "*.pnf" "*.po" "*.ppd" "*.prp" "*.pyo" "*.qtx" "*.rbf" "*.rm" "*.schdocpreview" "*.sd0" "*.sd1" "*.sd2" "*.spd" "*.swf" "*.tbl" "*.tga" "*.ts" "*.ttc" "*.txt#" "*.upi" "*.vcd" "*.vcp" "*.vdb" "*.vds" "*.vhf" "*.wfm" "*.wld" "*.xci" "*.xfd" "*.xtda"
#maybe "*.s" "*.asm" "*.ise"
...
find_type_d_iname git.tar ".git" ".gitignore" ".gitattributes" # this line may unintentionally grab useful stuff...
...
#find_type_f_iname firmware.tar "*.vhd" "*.vhdl" "*.v" "*.sv" "*.ucf" "*.xdc" "*.xco" "*.xise" "*.gise" "*.bd" 
