...
# last updated 2025-02-01 by mza
...
find_type_f_iname junk.tar "*.swp" "*.tmp" "*~" "*.bak" "*.so" "*.o" "*.sys" "*.schbak" "*.sch_bak" "*.symbak" "*.edn" "*.lock" "*.lnk" "*.cls" "*.dvi" "*.aux" "*.obj" "*.out1" "*.vsd" "*.ll" "*.rep" "*.prm" "*.lst" "ntuser.dat*" "*.pcap" "*.pyc" "*.exe.stackdump" ".DS_Store" "desktop.ini" "hiberfil.sys" "pagefile.sys" "*.m3u"
...
#"*.txt.gz"
find_type_f_iname data.tar "*.data" "*.root" "*.sroot" "*.rawdata" "*.dat" "*.hdf5" "*.usb0" "*rawdata.[0-9][0-9][0-9][0-9][0-9]" "*rawdata.[0-9][0-9][0-9][0-9]" "*.rawdata[0-9][0-9][0-9]" "S*CH[0-9]" "PHD_S*CH[0-9]" "*.fiber[0-9]" "*.camac" "ccc[0-9]" "ccc" "aaa" "*.dst" "*.dst[0-9]" "*.datafile" "*.spl" "*.prn" "*.wxform" "*.ped"
find_type_f_iname executable.tar "*.dll" "*.aps" "*.ncb" "*.sbr" "*.idb" "*.xpm" "*.res" "*.icon" "*.ico"
...
find_type_d_iname firmware-build.tar "__projnav" "xst" "_ngo[0-9]"
find_type_f_iname firmware-build.tar "*.srp" "*.ndf" "*.ref" "*.str" "*.ise_ISE_Backup" "*.restore" "*.mgf" "*.dcp" "*.xsvf" "*.svf" "*.xmsgs" "*.xrpt" "*.vdbl" "*.syr" "*.twr" "*.twx" "*.wdb" "*.ngo" "*.vho" "*.mrp" "*.msd" "*.rpx" "*.rpt" "*.rbd" "*.rbb" "*.ngc" "*.ngd" "*.ncd" "*.ngr" "*.ngm" "*.mcs" "*.mcs.gz" "*.bit" "*.bit.gz" "*.hdf" "*.projectmgr" "*.xbcd" "*.xreport" "par_usage_statistics.html" "*.cmd_log" "*.elf" "*.blc" "*.bld" "*.unroutes" "*.par" "*.bgn" "*.map" "*.drc" "*.cdc" "*.xdl" "*.asdb" "*.cgc" "*.cpj" "*.psr" "*.do" "*.glade" "*_flist.txt" "*_readme.txt" "*_pad.txt" "*.ptwx" "*.ut" "*.tsi" "*.cgp" "*.scr" "*.key" "*_xmdf.tcl"
...
find_type_f_iname long-tail.g.tar "*.g" "*.g4m" "*.g95" "*.geom" "*.gmmp" "*.gnome" "*.gnuplot_history" "*.gp" "*.gpg" "*.gplt" "*.gtkw" "*.guess" "*.gvp"
...
find_type_f_iname long-tail.i.tar "*.ibmc" "*.ic0" "*.ics" "*.icw" "*.ident" "*.ifx" "*.ihh" "*.ilc" "*.iml" "*.index" "*.info-1" "*.info-2" "*.info-3" "*.info-4" "*.init-script" "*.inpfiles" "*.inputrc" "*.ins" "*.install" "*.intel" "*.ipc" "*.ipv6" "*.ipx" "*.isim_lau_prj" "*.isp" "*.ita" "*.itb" "*.itcl" "*.itf" "*.ith" "*.ix"
...
find_type_f_iname long-tail.v.tar "*.v20140221-1700" "*.v2cc" "*.va" "*.vala" "*.var" "*.vars" "*.vbp" "*.vbproj" "*.vbs" "*.vbw" "*.vcawin32" "*.vcwin32" "*.ver" "*.version" "*.versionsbackup" "*.vis" "*.vlogifrc" "*.vlr" "*.vpi" "*.vwp"
...
find_type_f_iname long-tail.10MB.tar "*.acd" "*.acm" "*.adb" "*.adm" "*.adml" "*.admx" "*.adr" "*.ads" "*.afm" "*.ai" "*.ali" "*.amx" "*.ani" "*.ax" "*.bat" "*.bcc" "*.bcm" "*.bkg" "*.bpl" "*.btr" "*.cbz" "*.cdf-ms" "*.cel" "*.chq" "*.cmf" "*.cnv" "*.cpa" "*.crt" "*.csa" "*.dat#" "*.dcm" "*.ddd" "*.dectest" "*.deu" "*.devhelp2" "*.dmc" "*.dml" "*.dmo" "*.dms" "*.drv" "*.dtx" "*.dvg" "*.dvr-ms" "*.efi" "*.eml" "*.emn" "*.enu" "*.eps#" "*.exsd" "*.fdf" "*.fits" "*.fmwr" "*.fon" "*.form" "*.g1" "*.gcc" "*.gdt" "*.gid" "*.gir" "*.grc" "*.grd" "*.hdx" "*.heic" "*.hkp" "*.hwdef" "*.hwh" "*.hxx" "*.hyp" "*.idf" "*.if2" "*.ifd" "*.ime" "*.ind" "*.inx" "*.itk" "*.jrs" "*.jsonlz4" "*.lan" "*.less" "*.lex" "*.lf-r" "*.lgc" "*.lhp" "*.lis" "*.lng" "*.ltl" "*.lxa" "*.lyt" "*.m4" "*.mfl" "*.mine" "*.mjs" "*.mof" "*.msc" "*.msg" "*.msstyles" "*.mst" "*.mum" "*.nap" "*.nld" "*.nlp" "*.nlt" "*.ntf" "*.ocx_38c869db" "*.old" "*.pad_txt" "*.pages" "*.pd4" "*.pedsub_hitscfd" "*.pem" "*.pfa" "*.pfb" "*.pkginfo" "*.pm" "*.pptm" "*.psd" "*.pt07" "*.pyd" "*.r" "*.r53657" "*.r53921" "*.r54265" "*.regtrans-ms" "*.resources" "*.rom" "*.rootmap" "*.rpo" "*.sch_1" "*.schdot" "*.sdf" "*.sdo" "*.shx" "*.sql" "*.tcc" "*.texi" "*.tfm" "*.tlb" "*.tui" "*.ui" "*.upd" "*.vc" "*.vch" "*.vdf" "*.vf" "*.vp" "*.wat" "*.whl" "*.wma" "*.wmf" "*.wsp" "*.xda" "*.xpd" "*.xraw" "*.xrm-ms" "*.xsl" "*.xtd" "*.xwv"
...
#find_type_f_iname asic.tar "*.spc" "*.sp" "*.vdo" "*.vdb" "*.tdb" "*.tdo" "*.edif" "*.tsdat" "*.tsmeas" "*.tsim" "*.tsdb" "*.wmf" "*.tanner" "*.gds" "*.gds2" "*.lvs" "*.drc" "*.layout" "*.oalib" "*.citi"
#find_type_f_iname asic.tar "*.txt" "*.pdf" "*.pptx" "*.png" "*.xls" # this will grab too much unrelated stuff...
#find_type_f_iname pcb.tar "*.d" "*.pcbdoc" "*.schdoc" "*.schlib" "*.sch" "*.pcb" "*.kicad_pcb" "*.kicad_sch" "*.brd" "*.ln9" "*.ld9" "*.pt9" "*.pd9" "*.prjpcb"
#find_type_f_iname mechanical.tar "*.sldprt" "*.sldasm" "*.dxf" "*.dwg" "*.stp" "*.step" "*.stl"
#find_type_f_iname firmware.tar "*.vhd" "*.vhdl" "*.vh" "*.v" "*.sv" "*.ucf" "*.xdc" "*.xco" "*.xise" "*.gise" "*.bd" "*.xpr" "*.wcfg" "*.mk" "*.gfl" "*.dhp" "*.ipf" "*.pad" "*.pl" "*.tpl" "*.eco" "*.xpi" "*.prj" "*.vm6" "*.jed" "*.sym"
...
# audio.tar ogg mp3 aac wma amr
# video.tar avi mov mpg mp4 mkv wmv flv 3gp
# google-docs.tar gdoc gslides gsheet
# kek-firmware.tar "*.hsprogs" "*.bitfiles"
# "*.md"
# "*.pub"
# "*.tcal" "*.mplstyle"
# "*.gd1[0-9]" "*.gd[0-9]"
# PDK.tar "*.pl" "*.l" "*.sav" "*.il" "*.inc" "*.cfg" "*.zap"
